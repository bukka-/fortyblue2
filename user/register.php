...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once($_SERVER['DOCUMENT_ROOT']."/user/libraries/password_compatibility_library.php");
}

// include the configs / constants for the database connection
require_once($_SERVER['DOCUMENT_ROOT']."/user/config/db.php");

// load the registration class
require_once($_SERVER['DOCUMENT_ROOT']."/user/classes/Registration.php");
...
include($_SERVER['DOCUMENT_ROOT']."/user/views/register.php");
